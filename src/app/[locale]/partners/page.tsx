...
import { partners, regions, type Region } from '@/data/partners';
...
export default function PartnersPage() {
  ...
  }, [searchQuery, selectedRegion, selectedTier, onlyGir]);
    ...
    <div className="pt-16">
      ...
      <section className="py-8 bg-sand-50">
        <div className="container mx-auto px-4">
          ...
          {viewMode === 'map' && (
            <div className="mb-8">
              <PartnersWorldMap locale={locale} />
            </div>
          )}
...
function PartnerCard({ partner, locale }: { partner: typeof partners[0]; locale: string }) {
  const t = useTranslations('partners');
    ...
    >
      ...
      <div className="p-6 pb-4">
        <div className="flex items-start gap-4">
          <div className="w-16 h-16 bg-sand-100 rounded-xl flex items-center justify-center flex-shrink-0">
            {partner.logo ? (
              <Image
                src={partner.logo}
                alt={partner.name}
